...
"""
Functions from visualizations
"""

global __ATOM_LIST__
__ATOM_LIST__ = [x.strip() for x in
...
if __name__ == '__main__':
    ...
    xyz_filepath_list = list(glob('./model_lz/generated/generated_xyz_files/*.xyz'))
